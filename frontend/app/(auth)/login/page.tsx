  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-100 rounded-full blur-3xl opacity-40 animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-indigo-100 rounded-full blur-3xl opacity-40 animate-pulse" />
      </div>
      ...
      <motion.div
        ...
        className="bg-white/80 backdrop-blur-sm border border-white/50 shadow-xl rounded-2xl p-10 w-full max-w-md"
      >
